...
export class AlumnoService {
  ...
  private baseEndpoint = 'http://servicio-gateway-microservicios-spring-mysql-backend.openshift-demo-ea9753cca330b7f05a99ad5b2c8b5da1-0000.us-east.containers.appdomain.cloud/api/alumnos';
